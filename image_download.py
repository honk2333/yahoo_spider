...
def down_url(param = ()):
    ...
    path = os.path.join('/home/ubuntu/MultiModal-Extractor/spider/nytimes_news/superJumbo/27', target_name)
...
def download_from_dir():
    ...
    path = '/home/ubuntu/MultiModal-Extractor/spider/filtered/数据/27'
